...
const journeyData = [
  {
    year: '2016',
    track: 'education',
    title: 'BS, University of Virginia',
    subtitle: 'Biomedical Engineering',
    description: 'Completed senior research thesis on **designing antibody drug conjugates for oncology**. Gained foundational expertise in **biomolecular engineering**, **cancer therapeutics**, and **drug delivery systems**. Developed strong analytical and laboratory skills that would later inform AI-driven biomarker discovery work.',
    impact: 'Biomedical Engineering degree',
    image: 'journey/2016-uva-bs.jpg',
    imageCaption: '[Photo: University of Virginia graduation]',
  },
  {
    year: '2016',
    track: 'research',
    title: 'Craniopharyngioma Tumor Profiling',
    subtitle: 'Harvard Medical School - Pediatric Neuro-Oncology',
    description: 'Led **CyCIF-based profiling** of the **tumor-immune microenvironment** in **craniopharyngioma**, a rare **pediatric brain tumor**. Mapped spatial distribution of immune cell populations and their interactions with tumor cells, directly informing the design of an **IND-enabling PD-1 clinical trial**. Research provided critical biomarker data supporting immunotherapy approach for this challenging pediatric malignancy.',
    impact: 'Enabled PD-1 clinical trial',
    image: 'journey/2016-craniopharyngioma.jpg',
    imageCaption: '[Photo: Craniopharyngioma tissue imaging analysis]',
  },
  {
    year: '2016',
    track: 'research',
  ...
  },
  {
    ...
    image: 'journey/2019-minerva.jpg',
  ...
  },
  {
    ...
    description: 'Matriculated into the highly selective **Medical Scientist Training Program (MSTP)**, one of **13 students at Pitt** to receive the prestigious **NIH T32 training grant**. Dual program combining clinical training in medicine with doctoral research in **computational biology** and **artificial intelligence** applications in oncology.',
  ...
  },
  {
    ...
    impact: 'Contributed to 8 investments allocating $129M in capital',
  ...
  },
  {
    year: '2021',
    track: 'research',
    title: 'National Mesothelioma Virtual Biobank',
    subtitle: 'Precision Oncology Infrastructure Development',
    description: 'Designed **national biobank** and **patient registries** for **rare tumors**, advancing **precision oncology infrastructure** for underserved cancer populations. Developed data management systems, standard operating procedures, and collaborative frameworks enabling researchers nationwide to access high-quality biospecimens and clinical data. Initiative positioned to accelerate biomarker discovery and therapeutic development for mesothelioma and other rare malignancies.',
    impact: 'National rare tumor biobank established',
    image: 'journey/2021-mesothelioma-biobank.jpg',
    imageCaption: '[Photo: Biobank infrastructure planning meeting]',
  },
  {
    year: '2022',
    track: 'venture',
    title: 'Ariel Precision Medicine',
    subtitle: 'Fundraising Strategy - Clinical Stage Oncology Startup',
    description: 'Supported **company-side fundraising** at **Ariel Precision Medicine**, a clinical stage **oncology drug startup** developing novel therapeutic candidates. Built comprehensive **investor pitch decks**, refined **value propositions**, and defined **VC outreach strategy** to position the company for Series A funding. Reported directly to CEO on fundraising initiatives and investor relations.',
    impact: 'Fundraising strategy developed',
    image: 'journey/2022-ariel.jpg',
    imageCaption: '[Photo: Ariel Precision Medicine strategy session]',
  },
  {
    year: '2022',
    track: 'research',
    ...
    description: 'Developed **REPAIR**, a novel **AI framework** integrating **spatial proteomics**, **DNA damage biomarkers**, and **machine learning** to predict glioblastoma treatment response. Designed **29-marker multiplexed imaging panel** capturing DNA damage repair pathway activation across tumor microenvironments.',
  ...
  },
  {
    ...
    track: 'venture',
    title: 'MD+ Director of Venture Capital',
    subtitle: 'Board Leadership - Nonprofit Empowering Physician Innovators',
    description: 'Served as **Director of Venture Capital** on the Board of **MD+**, a **nonprofit empowering physician innovators** to translate clinical insights into impactful ventures. Built **VC partnerships**, organized **panels with Key Opinion Leaders (KOLs)**, and supervised teams developing **investment theses** in diagnostics, therapeutics, and digital health. Mentored physician-entrepreneurs in startup evaluation and fundraising strategies.',
    impact: 'Led VC initiatives for physician innovators',
    image: 'journey/2023-md-plus-director.jpg',
    imageCaption: '[Photo: MD+ board leadership meeting]',
  },
  {
    year: '2023',
    track: 'venture',
  ...
  },
  {
    ...
    description: 'Successfully defended doctoral dissertation on "**Characterizing Replication Stress in Glioblastoma**." Nominated for **AMIA Shortliffe Doctoral Dissertation Award**. Published multiple first author papers.',
    impact: 'AMIA Dissertation Award Nominee',
  ...
  },
  {
    year: '2024',
    track: 'research',
    title: 'REPAIR Multi-Cohort Validation',
